...
CREATE TABLE IF NOT EXISTS dws_spu_daily_sales (
    spu_id              STRING,
    spu_name            STRING,
    brand               STRING,
    stat_date           STRING,
    ...
    buyer_uv            BIGINT,
    PRIMARY KEY (spu_id, stat_date) NOT ENFORCED
) WITH (
    'connector' = 'paimon',
    'bucket' = '2',
    'sink.parallelism' = '1'
...
INSERT INTO dws_spu_daily_sales
SELECT
    spu_id,
    ...
    COUNT(DISTINCT order_item_id)                        AS sku_sold_cnt,
...
GROUP BY spu_id, DATE_FORMAT(create_time, 'yyyy-MM-dd');
